# your-nix-config/modules/minecraft/paper-service.nix
{
  config,
  pkgs,
  lib,
...
# This function now takes fewer custom arguments
{
  minecraftVersion,
  paperBuild,
  pluginsJarsSrc, # Path to directory with only plugin JARs
  memoryLimit ? "8G", # Default memory limit
# Removed pluginsConfigSrc and serverConfigsSrc
}:
